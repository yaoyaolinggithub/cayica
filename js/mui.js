...
(function($, document, undefined) {
	...
	var CLASS_ICON_PULLDOWN = 'iconfont mui-icon-pulldown';
...
(function($, window) {
	...
	Transparent.prototype.handleScroll = function() {
		...
		if(ui&&ui.title){ui.title.style.opacity=window.scrollY>145?(window.scrollY - this.options.top) / this.options.offset:0;}
	};
